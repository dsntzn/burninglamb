...
const Arrow = ({ className }) => (
  <div className={twMerge(className)}>
    <svg width="102" height="58" viewBox="0 0 51 29" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path className="arrow-line origin-left duration-500 scale-x-[66%] group-hover:scale-x-100 group-hover:stroke-white transition-all" d="M49.5137 14.3005L0 14.5005" stroke="#000" stroke-width="2.63889" stroke-linecap="square" strokelinejoin="round" />
