...
const BigButton = ({ href = 'mailto:hi@burninglamb.eu', title, className, id, ...props }) => (
  <a id={id} href={href} className={twMerge("relative group border-y-0.5 border-y-transparent hover:border-y-white transition-colors flex flex-nowrap items-center lg:items-baseline justify-between text-black hover:text-white duration-500 py-4 md:py-8 w-full", className)} {...props} >
